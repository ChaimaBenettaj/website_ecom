...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3791134404ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestionclients&table=client">`gestionclients`.`client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestionclients&table=lignedecommande">`gestionclients`.`lignedecommande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestionclients&table=commande">`gestionclients`.`commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestionclients&table=produit">`gestionclients`.`produit`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gestionclients&table=Client">`gestionclients`.`Client`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rcrt_hiring&table=candidats_studies">`rcrt_hiring`.`candidats_studies`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=rcrt_hiring&table=candidats_skills">`rcrt_hiring`.`candidats_skills`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hiring&table=postulation">`hiring`.`postulation`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hiring&table=recruiters">`hiring`.`recruiters`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hiring&table=offer">`hiring`.`offer`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="755e5b33444b7e21253e5c793176502a">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="gestionclients" targettable="client">
